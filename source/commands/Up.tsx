...
export default function Up() {
	...
	const { status, startExecution, containers } = useDockerCommands(symlinks, ['compose', 'up', '-d']);
	...
	return (
		<Box width={WIDTH} flexDirection="column">
			...
			{ status === 'stopped' && <Alert variant="info">
				{ !group ? 'Choose a group' : 'Select the symlinks to run' }
			</Alert> }
